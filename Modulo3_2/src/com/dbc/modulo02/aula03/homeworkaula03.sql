...
--EXERCICIOS AULA03
--=====================
SELECT p.ID_PESSOA, c.ID_PESSOA 
FROM PESSOA p
...
SELECT PESSOA.ID_PESSOA , CONTATO.ID_CONTATO 
FROM PESSOA
INNER JOIN CONTATO
ON PESSOA.ID_PESSOA = CONTATO.ID_CONTATO;


---=======================

SELECT a.ID_ENDERECO , b.ID_ENDERECO 
FROM PESSOA_X_PESSOA_ENDERECO a
INNER JOIN ENDERECO_PESSOA b 
...
INNER JOIN PESSOA_X_PESSOA_ENDERECO a ON a.ID_PESSOA  = p.ID_PESSOA
INNER JOIN ENDERECO_PESSOA b ON b.ID_ENDERECO = a.ID_ENDERECO
...
LEFT JOIN PESSOA_X_PESSOA_ENDERECO a ON p.ID_PESSOA = a.ID_PESSOA
LEFT JOIN ENDERECO_PESSOA b ON b.ID_ENDERECO = a.ID_ENDERECO
...
RIGHT JOIN PESSOA_X_PESSOA_ENDERECO a ON p.ID_PESSOA = a.ID_PESSOA
RIGHT JOIN ENDERECO_PESSOA b ON b.ID_ENDERECO = a.ID_ENDERECO
...
FULL JOIN PESSOA_X_PESSOA_ENDERECO a ON p.ID_PESSOA = a.ID_PESSOA
FULL JOIN ENDERECO_PESSOA b ON b.ID_ENDERECO = a.ID_ENDERECO
